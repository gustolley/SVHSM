...
set run_name=SVHSM_v3_sensitivity

set MF_dir=MODFLOW_v3
set SWBM_dir=input_150m_grid
set UCODE_dir=UCODE_v3

set UCODE_in_file=SVHSM_v3_sensitivity.in
set UCODE_out_file=SVHSM_v3_sensitivity_out
set UCODE_param_file=SVHSM_v3_sensitivity.param
set master_bat=Run_SVHSM_sensitivity_master.bat
set runner_bat=Run_SVHSM_sensitivity_runner.bat
...
for /L %%i in (1,1,10) do (  
  ...
  copy ..\Batch_Scripts\%runner_bat% %run_name%\Runner%%i\Run_SVHSM.bat
)
xcopy %run_name%\Runner1 %run_name% /E /Y 
copy ..\Batch_Scripts\%master_bat% %run_name%\Run_SVHSM.bat
